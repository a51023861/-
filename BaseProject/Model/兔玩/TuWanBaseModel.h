...
@class TuWanDataModel,TuWanDataIndexpicModel,TuWanDataIndexpicInfochildModel,TuWanDataIndexpicShowitemModel,TuWanDataIndexpicShowitemInfoModel,TuWanListModel;
...
@property (nonatomic, copy) NSString *NStypename;
...
@property (nonatomic, copy) NSString *NSdescription;
