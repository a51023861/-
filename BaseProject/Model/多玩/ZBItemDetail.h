...
@class ZBItemDetailExtattrsModel;
@interface ZBItemDetail : BaseModel

@property (nonatomic, strong) ZBItemDetailExtattrsModel *extAttrs;
...
@interface ZBItemDetailExtattrsModel : NSObject
