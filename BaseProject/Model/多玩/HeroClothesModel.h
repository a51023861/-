...
@class Heroclothesarraymodel;
@interface HeroClothesModel : BaseModel

@property (nonatomic, strong) NSArray<Heroclothesarraymodel *> *HeroClothesArrayModel;

@end

@interface Heroclothesarraymodel : NSObject
